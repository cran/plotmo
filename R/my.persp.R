# my.persp: Copied from R 2.13-1 sources and  annoying warning
#           "surface extends beyond the box" removed.  So this
#           is now compatible with R prior to version 2.13-1.
#
...
my.persp <- function(x, ...) UseMethod("my.persp")
