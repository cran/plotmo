...
plotmo.convert.na.nresponse.rq <- function(object, nresponse, yhat)
{
    if(NCOL(yhat) == 1)
        nresponse <- 1
    else {
...
plotmo.convert.na.nresponse.rqs <- function(object, nresponse, yhat)
{
    plotmo.convert.na.nresponse.rq(object, nresponse, yhat)
}
