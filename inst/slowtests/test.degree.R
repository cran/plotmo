...
# degree1 tests
par(mfrow=c(3,3), mar=c(3,2.5,2,1), oma=c(0,0,4,0))
...
plotmo(a81, do.par=FALSE, degree1=0, degree2=c("age", "se"), main='degree2=c("age", "se")')
...
# following works but should possibly give a warning (both elems of degree2 the same)
plotmo(a81, degree1=0, degree2=c("sex", "sex"),
       main='degree2=c("sex", "sex")', SHOWCALL=TRUE)
