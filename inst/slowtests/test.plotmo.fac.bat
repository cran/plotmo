...
@"C:\PROGRA~1\R\R-3.1.2\bin\x64\R.exe" CMD BATCH --quiet --vanilla test.plotmo.fac.R
...
@diffps -s Rplots.ps ..\..\.#\test-reference\test.plotmo.fac.save.ps
@exit /B 1
:good2
@rem test.plotmo.fac.save.ps is too big to be included in the release
@rem so it is stored elsewhere
diffps Rplots.ps ..\..\.#\test-reference\test.plotmo.fac.save.ps
